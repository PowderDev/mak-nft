...
import { ERC20Mock, VRFCoordinatorV2Mock } from "../typechain-types";

const DEFAULT_GAS_LANE = "0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc";
...
before(async () => {
  const VRFmockFactory = await hre.ethers.getContractFactory("VRFCoordinatorV2Mock");
  vrf = await VRFmockFactory.deploy("0", "0");
...
describe("MakNFT", function () {
  async function defaultFixture() {
    ...
    const makNFT = await makNFTFactory.deploy(
      vrf.getAddress(),
      subId,
      DEFAULT_GAS_LANE,
      DEFAULT_GAS_LIMIT,
